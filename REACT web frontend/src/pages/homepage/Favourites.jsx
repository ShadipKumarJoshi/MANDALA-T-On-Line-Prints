        ...
        {favouriteItems.length > 0 ? (
          favouriteItems.map((item, index) => (
            ...
            >
              <Image
                width={150}
                src={`http://localhost:8000/designs/${item.designId.designImage}`}
                alt={item.designName}
                preview={{
                  src: `http://localhost:8000/designs/${item.designId.designImage}`,
                }}
              />
              <ItemDetails>
                <ItemName>{item.designId.designName}</ItemName>
                <ItemPrice>Rs. {item.designId.designPrice}</ItemPrice>
              ...
              <Button
                ...
                danger
                icon={<DeleteOutlined />}
                onClick={() => handleDeleteFavourite(item.designId._id)}
              >
                Remove
              </Button>
            </FavouriteItem>
